function boxEdited(num) {
	...
	if(num === 0) {
		...
		input[0].value = parseInt(input[0].value) * 160
		input[2].value = parseInt(input[1].value) / 160
		input[3].value = parseInt(input[0].value) * 8
	} else if (num === 2) {
		input[0].value = parseInt(input[0].value) * 160 * 160
		input[1].value = parseInt(input[1].value) / 160
		input[3].value = parseInt(input[0].value) * 8
	} else if (num === 3) {
		input[0].value = parseInt(input[0].value) / 8
		input[1].value = parseInt(input[0].value) / 160
		input[2].value = parseInt(input[1].value) / 160
	} 
}
